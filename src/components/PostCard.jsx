  ...
  return (
    <div className="bg-blackGold p-4 my-4 rounded-2xl">
      ...
      <div>
        ...
        <div className="flex gap-4 text-lightGray text-xs my-4">
          ...
          {showAll ? (
            <>
              {comments.map((comment) => (
                <div
                  className="p-2 border-gray rounded-xl border my-4 max-w-full overflow-x-auto"
                  key={comment._id}
                >
                  ...
                  <div className="bg-goldenGray p-3 my-4 rounded-2xl">
                    ...
                    {comment.image && (
                      <img className="w-1/2" src={comment.image} alt="" />
                    )}
                  </div>
                </div>
              ))}
              <div
                className="bg-goldenGray px-6 py-2 rounded-lg w-fit mx-auto "
